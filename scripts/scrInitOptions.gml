///scrInitOptions()
//Game options
global.gameName = "I Wanna Avoid being Trolled"; //Name that will be displayed on the game window
...
//Misc. options
global.startRoom = rS1; //The room where the game will start
global.useClearRoom = false; //If you wanna use the clear room (like a portal room) set this to true
global.clearRoom = rEnd; //The room you wanna be sent to as a clear room
